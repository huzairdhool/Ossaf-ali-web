...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "e22abcd3-c14f-453a-8a73-f020b798cbb2");
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="text-gray-600">
                ...
                <p className="mb-4 font-medium">+923338431038</p>
                <div className="flex items-center mb-2">
                <img src={assets.mail} className='w-5 mr-2'></img>
                  <span className='text-blue-400'>Email us</span>
                </div>
                <p className="mb-4 font-medium">osaafalipropertycenter@gmail.com</p>
                <div className="flex items-center mb-2">
                <img src={assets.loc_icon} className='w-5 mr-2'></img>
                  <span className='text-blue-400'>Address</span>
                </div>
                <p className='font-medium'>Ossaf Ali Property center Rehman shaheed road, Gujrat</p>
